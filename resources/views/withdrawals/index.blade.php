        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Pending Withdrawal Requests List</h4>
                    <a href="{!! route('withdrawals.excel.form',0) !!}">
                                        ...
                                        <tbody>
                                            @foreach($withdrawals as $withdrawal)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{!! route('withdrawals.approve',$withdrawal->id) !!}" class="delete_button">    
                                                            <i class=" bx bx-log-in-circle fs-20" id="accepted-logo"></i>
                                                        </a>
                                                        &nbsp;&nbsp;
                                                        <a href="{!! route('withdrawals.reject',$withdrawal->id) !!}" class="delete_button"
